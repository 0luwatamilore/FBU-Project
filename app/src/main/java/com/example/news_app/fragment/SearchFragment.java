...
public class SearchFragment extends Fragment {
    ...
    private String SEARCH_URL = "https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=100&q=";
    User currentUser;
//    EditText etSearch;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        etSearch.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() {
            @Override
    ...
    public void createSearch(View view){
        ...
        searchRequest();
        SEARCH_URL = "https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=100&q=";
    }
